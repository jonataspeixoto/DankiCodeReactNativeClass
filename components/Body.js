...
const Body = () => {
    return (
        ...
        <View style={{ flex: 1, flexDirection: 'row', flexWrap: 'wrap', padding:30, justifyContent:'center' }}>
            ...
            />
            <Text style={{ width:'100%', paddingLeft:20, paddingRight:20, paddingTop:20}}>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam malesuada porta tincidunt. Nunc gravida nisl neque, vitae commodo tortor suscipit sed. Suspendisse ultrices gravida dui, nec ullamcorper elit ultricies vitae. Aliquam in tincidunt magna, ut commodo ligula. Sed condimentum dui nunc, in eleifend neque lacinia quis. Fusce felis quam, tincidunt ut sodales id, rhoncus ut est. Etiam ac urna non mi hendrerit porttitor. Nullam eget sem vitae ante fringilla laoreet. Nam id sapien est. Fusce a est at enim lacinia consectetur. Suspendisse ultricies felis vel tempus bibendum. Suspendisse potenti. Praesent elit ligula, commodo eget leo in, venenatis vehicula nulla. Duis eros lacus, auctor vitae libero vel, dapibus cursus orci. Morbi hendrerit, ante at placerat aliquet, metus ipsum tincidunt ipsum, in viverra ex nisl sit amet tortor. In sodales accumsan urna, in congue enim eleifend lacinia.
